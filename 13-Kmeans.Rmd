...
1. The code above will do 100 iterations, but what if the algorithm converges after 20? Alter the code so it stops when no changes are made and help save the planet.
2. Write a function from this code that will take `data`, `K`, and `iterations` as an argument and perform Kmeans clustering. Return a list that contains the cluster assignments and data.
