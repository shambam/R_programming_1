...
\hypersetup{
  pdftitle={An introduction to R programming},
  pdfauthor={Shamit Soneji},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{An introduction to R programming}
...
The purpose of this course is to teach you the basics of the R language and give you the confidence to tackle larger projects using the language. \emph{Importantly, we want to get you thinking like a programmer}. This doesn't mean that by the end of the course you will know R fully, but you will know enough so you can go online and look for the help you need to complete most tasks.

\hypertarget{practice-makes-perfect}{%
\section{Practice makes perfect}\label{practice-makes-perfect}}

Programming is like any skill, the more you practice the better you get. \textbf{\emph{It's really important that you keep using what you have learned after the course is completed}} otherwise there is a good chance you will forget everything and you'll be back to square one.
...
\hypertarget{what-other-languages-do-bioinformaticians-use}{%
\section{What other languages do bioinformaticians use?}\label{what-other-languages-do-bioinformaticians-use}}
...
Point your browser to \url{http://cran.r-project.org/} to download and install the latest version of R. For these tutorials we are also going o use \href{http://www.rstudio.com/}{RStudio} which is an advanced environment for R which includes a window for an editor, console, and plotting window. You will see what this means later.
