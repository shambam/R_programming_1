...
So ggplot is all about *layering* information onto plots, and this makes it very customisable. It definitely has a steeper learning curve, but worth it if you produce lots of plots on a day-to-day. We'll pick upp ggplot again later.

While we are dealing with vector, we can also do some basic maths on them:
