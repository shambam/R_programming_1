...
$$Z_i= \frac{g_i-\hat{g}}{\sigma_g_i}$$
Which means for every gene ($g_i$) we subtract the mean expression of the gene ($\hat{g)}$) to each expression value ($g_i$) and divide by the standard deviation of the expression of the gene ($\sigma_g_i$).
